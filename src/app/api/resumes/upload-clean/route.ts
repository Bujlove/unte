    ...
    try {
      await supabase
        ...
        .update({
          ...
          education_level: parsedData.education && parsedData.education.length > 0 ? parsedData.education[0].degree : undefined,
          skills: parsedData.professional.skills.technical,
          languages: parsedData.languages ? parsedData.languages.map(lang => lang.name) : [],
